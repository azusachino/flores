---
title: MySQL
created: 2022-09-14 03:57:59
modified: 2023-02-01 11:07:07
tags: [CS, DB]
---
...
在MySQL中，保存大字段(博客内容)的设计方案，其实是不太合理的。这种非常大的数据，可以保存到`mongodb`中，然后，在业务表保存对应`mongodb`的`id`即可。
...
- [21个MySQL表设计的经验准则](https://mp.weixin.qq.com/s/sSsZ-w6WzjA_DLZfnsxD2w)
